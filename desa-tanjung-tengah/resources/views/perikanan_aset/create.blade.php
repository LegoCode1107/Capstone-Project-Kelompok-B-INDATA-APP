...
<div class="indata-page-header">
    ...
    <div>
        <h1 class="indata-page-title">
            Tambah Data Perikanan & Aset Infrastruktur
        </h1>

        <p class="indata-page-sub">
            Tambahkan data aset infrastruktur dan perikanan desa
        </p>
    </div>
...
<div class="indata-card">
    ...
    <div class="indata-card-head">
        ...
        <div class="indata-card-title">
            ...
            Form Input Data Perikanan & Aset Infrastruktur
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               name="kelompok_aset"
                               value="{{ old('kelompok_aset') }}"
                               placeholder="Contoh: Perikanan, Jalan, Jembatan"
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nama_aset_infrastruktur') }}"

...
@section('title', 'Detail Data Perikanan & Aset')
...
<div class="indata-page-header">
    ...
    <div>
        <h1 class="indata-page-title">
            Detail Data Perikanan & Aset Infrastruktur
        </h1>

        <p class="indata-page-sub">
            Informasi lengkap data aset infrastruktur dan perikanan desa
        </p>
    </div>
...
<div class="indata-card">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="indata-total-badge">
                            ...
                            {{ number_format($data->volume_jumlah ?? 0, 2) }}
    ...
    <div class="indata-card-footer">
        ...
        <a href="{{ route('perikanan.edit', $data->id) }}"

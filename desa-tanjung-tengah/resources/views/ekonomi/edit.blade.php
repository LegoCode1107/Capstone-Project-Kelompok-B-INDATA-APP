...
@section('title', 'Edit Data Ekonomi & Pekerjaan')
...
<div class="indata-page-header">
    ...
    <div>
        <h1 class="indata-page-title">
            Edit Data Ekonomi & Pekerjaan
        </h1>

        <p class="indata-page-sub">
            Perbarui data sektor ekonomi dan pekerjaan masyarakat
        </p>
    </div>
...
<div class="indata-card">
    ...
    <div class="indata-card-head">
        ...
        <div class="indata-card-title">
            ...
            Form Edit Data Ekonomi & Pekerjaan
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('kategori_sektor', $data->kategori_sektor) }}"
                               required>
